...
pub const EP_CONTROL_UNDEFINED: u16 = 0x00;
pub const SAMPLING_FREQ_CONTROL: u16 = 0x01;
pub const PITCH_CONTROL: u16 = 0x02;

// Format Type Codes
pub const FORMAT_TYPE_UNDEFINED: u8 = 0;
